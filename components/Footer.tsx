      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
          ...
          <div>
            ...
            <div className="space-y-2">
              <a href="https://github.com/lobster-academy" target="_blank" rel="noopener noreferrer" className="block text-sm text-neutral-500 hover:text-white transition">GitHub</a>
